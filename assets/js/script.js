...
const sectors = [
  { color: "Aqua", label: "COLA" },
  { color: "SteelBlue", label: "FANTA" },
  { color: "DodgerBlue", label: "ESPRESSO" },
  { color: "Gold", label: "MILCHKAFFE" },
  { color: "Orange", label: "COLA" },
  { color: "Red", label: "FANTA" },
  { color: "MediumSeaGreen", label: "MILCHKAFFE" },
  { color: "ForestGreen", label: "CAPPUCHINO" },
  { color: "DarkOrchid", label: "ESPRESSO" },
  { color: "BlueViolet", label: "MILCHKAFFE" },
  { color: "Aqua", label: "COLA" },
  { color: "SteelBlue", label: "FANTA" },
  { color: "DodgerBlue", label: "ESPRESSO" },
  { color: "Gold", label: "MILCHKAFFE" },
